...
/**
 * Premium luxury Loader component designed with rotating geometric dashed-rings,
 * elegant text-only VENDORHUB branding, and ambient champagne/bronze glow leaks.
 * Supports full screen or subpage content container height options.
 */
const Loader = ({ 
  fullScreen = true, 
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center gap-8 relative z-10">
        {/* Animated geometric rings around logo */}
